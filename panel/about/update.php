                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h4 class="page-title m-0">ویرایش کردن درباره ما</h4>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="col-12">
                            <div class="card m-b-30">
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo '../'.pathBackend().'about.php/'.$id; ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            <label for="description" class="col-sm-2 col-form-label">توضیحات</label>
                                            <div class="col-sm-10">
                                                <textarea class="form-control form-control-lg" name="description" placeholder="توضیحات" id="description" cols="30" rows="10"><?php echo $result->description; ?></textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <div><img src="<?php echo '../../../backEnd/'.$result->image; ?>" alt="about" width="120" height="120"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-10">
