<?php
    ...
    $results = $db->paginate('partners',true, ($page-1));
?>
                        ...
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <h4 class="page-title m-0">لیست همکارها</h4>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <?php foreach ($results['results'] as $value):?>
                                            <tr>
                                                ...
                                                <td><?php echo substr(nl2br(htmlspecialchars_decode($value->bio)),0,50);echo strlen($value->bio) > 50 ? '...' : ''; ?></td>
                                                <td><?php echo empty($value->image) ? 'ثبت نشده است' : '<img src="../../backEnd/'.$value->image.'" alt="'.$value->username.'" width="120" height="120">'; ?></td>
                                                ...
                                                <td>
                                                <?php if(ACL::delete()): ?>
                                                    <form action="<?php echo pathBackend(); ?>partner.php/<?php echo $value->id; ?>" method="post">
